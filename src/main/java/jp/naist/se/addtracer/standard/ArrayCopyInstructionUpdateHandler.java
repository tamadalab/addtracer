...
public class ArrayCopyInstructionUpdateHandler extends TracerInstructionUpdateHandler implements MethodCreatable{
    ...
    public InstructionList updateInstruction(InstructionHandle handle, UpdateData d){
        ...
        if(arraycopy == null){
            arraycopy = createArrayCopyMethod(cg, d.getConstantPoolGen(), d);
        }
        ...
        il.append(d.getFactory().createInvoke(
            ...
            new Type[]{
                Type.OBJECT, Type.INT, Type.OBJECT, Type.INT, Type.INT, Type.INT
            },
    ...
    /**
     * System#arraycopy メソッドを以下の命令に置き換える．
     * <blockquote><pre>
     ...
     * </pre></blockquote>
     */
    public Method createArrayCopyMethod(ClassGen classGen, ConstantPoolGen poolGen, UpdateData d){
        ...
        MethodGen m = new MethodGen(
            ...
            "_arraycopy_for_addtracer", classGen.getClassName(), il, poolGen
        );
        m.setMaxLocals();
        m.setMaxStack();
