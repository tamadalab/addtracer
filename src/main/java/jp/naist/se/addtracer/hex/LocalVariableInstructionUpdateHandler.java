...
public class LocalVariableInstructionUpdateHandler extends TracerInstructionUpdateHandler{
    ...
    public InstructionList updateInstruction(InstructionHandle handle, UpdateData d){
        ...
        if(realType.equals(Type.INT) || realType.equals(Type.BYTE) || realType.equals(Type.SHORT) ||
           realType.equals(Type.CHAR) || realType.equals(Type.LONG)){
            value = value + "0x";
        }
        list.append(pushSystemOutAndStringBuffer(d, value));
        list.append(InstructionFactory.createLoad(realType, index));

        if(realType.equals(Type.INT) || realType.equals(Type.BYTE) || realType.equals(Type.SHORT) || realType.equals(Type.CHAR)){
            if(realType.equals(Type.BYTE)){
        ...
        else if(realType.equals(Type.LONG)){
            list.append(d.getFactory().createInvoke(
